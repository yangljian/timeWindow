function [fitness,newAddVMArrays] = getRandomFitness(workloads,addVMArrays,t,randomAddPlan)
    addpath(genpath('E:\时间窗口实验\timeWindow\randomTest\util')); 
    addpath(genpath('E:\时间窗口实验\timeWindow\function')); 
    [vmArrays,newAddVMArrays] = getVmByAddVm(addVMArrays,t,randomAddPlan);
    qos = getQoS(workloads,vmArrays);
    cost = getCost(addVMArrays);
    fitness = 300 * qos + cost/5;
end
